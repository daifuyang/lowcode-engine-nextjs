...
import { isI18nData, isJSExpression } from '@zerocmf/lowcode-utils';
...
export function checkPropTypes(value: any, name: string, rule: any, componentName: string) {
  ...
  if (typeof rule === 'string') {
    ruleFunction = new Function(`"use strict"; const PropTypes = arguments[0]; return ${rule}`)(
      PropTypes2,
    );
  }
...
export function parseData(schema: unknown, self: any, options: IParseOptions = {}): any {
  // console.log('parseData self',self)
