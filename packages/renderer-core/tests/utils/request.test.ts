...
describe('test utils/request.ts ', () => {
  it('buildUrl should be working properly', () => {
    ...
    expect(buildUrl('mockDataApi', { a: 1, b: 'a', c: [] })).toBe(
      'mockDataApi?serializedParams=serializedParams',
    );
    expect(buildUrl('mockDataApi?existingParamA=valueA', { a: 1, b: 'a', c: [] })).toBe(
      'mockDataApi?existingParamA=valueA&serializedParams=serializedParams',
    );
  ...
  it('request should be working properly', () => {
    ...
    request('https://someradomurl/api/list', 'GET', {}, {}, {})
      .then((response) => {
        expect(fetchMock).toBeCalledWith('https://someradomurl/api/list', {
          body: {},
          credentials: 'include',
          headers: {},
          method: 'GET',
  ...
  it('get should be working properly', () => {
    ...
    get('https://someradomurl/api/list', {}, {}, {})
      .then((response) => {
        expect(fetchMock).toBeCalledWith('https://someradomurl/api/list', {
          body: null,
  ...
  it('post should be working properly', () => {
    ...
    post('https://someradomurl/api/list', [1, 2, 3, 4], {}, {})
      .then((response) => {
        expect(fetchMock).toBeCalledWith('https://someradomurl/api/list', {
          body: '[1,2,3,4]',
          headers: {
    ...
    post('https://someradomurl/api/list', { a: 1, b: 'a', c: [] }, {}, {})
      .then((response) => {
        expect(fetchMock).toBeCalledWith('https://someradomurl/api/list', {
  ...
  it('jsonp should be working properly', () => {
    ...
    jsonp('https://someradomurl/api/list', {}, { otherParam1: '123' }).catch(() => {
      expect(mockFetchJsonp).toBeCalledWith('https://someradomurl/api/list?params', {
        timeout: 5000,
        otherParam1: '123',
      });
      mockSerializeParams.mockClear();
