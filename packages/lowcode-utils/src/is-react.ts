...
export function isReactClass(obj: any): obj is ComponentClass<any> {
  return (
    obj && obj.prototype && (obj.prototype.isReactComponent || obj.prototype instanceof Component)
  );
}

export function acceptsRef(obj: any): boolean {
  return (
    obj?.prototype?.isReactComponent || (obj.$$typeof && obj.$$typeof === REACT_FORWARD_REF_TYPE)
  );
}
